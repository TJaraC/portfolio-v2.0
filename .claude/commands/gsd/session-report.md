...
<execution_context>
@E:/tricio_s_application/.claude/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @E:/tricio_s_application/.claude/get-shit-done/workflows/session-report.md end-to-end.
</process>
