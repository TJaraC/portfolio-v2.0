...
<execution_context>
@E:/tricio_s_application/.claude/get-shit-done/workflows/code-review-fix.md
</execution_context>
...
Execute the code-review-fix workflow from @E:/tricio_s_application/.claude/get-shit-done/workflows/code-review-fix.md end-to-end.
