...
Intel system is disabled. To activate:
  ...
  node E:/tricio_s_application/.claude/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node E:/tricio_s_application/.claude/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node E:/tricio_s_application/.claude/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node E:/tricio_s_application/.claude/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: E:/tricio_s_application/.claude/get-shit-done/bin/gsd-tools.cjs
