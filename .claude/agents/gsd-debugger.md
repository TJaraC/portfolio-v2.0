...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = E:/tricio_s_application/.claude
                  → checks E:/tricio_s_application/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = E:/tricio_s_application/.claude/get-shit-done
                  → writes to E:/tricio_s_application/.claude/get-shit-done/hooks/
...
@E:/tricio_s_application/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @E:/tricio_s_application/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "E:/tricio_s_application/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "E:/tricio_s_application/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "E:/tricio_s_application/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
