...
<reference>
@E:/tricio_s_application/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `E:/tricio_s_application/.claude/get-shit-done/references/user-profiling.md` to load:
