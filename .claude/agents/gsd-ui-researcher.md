...
Use template from `E:/tricio_s_application/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `E:/tricio_s_application/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "E:/tricio_s_application/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
