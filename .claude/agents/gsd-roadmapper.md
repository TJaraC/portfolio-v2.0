...
Reference full template: `E:/tricio_s_application/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `E:/tricio_s_application/.claude/get-shit-done/templates/state.md`.
