...
See E:/tricio_s_application/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using E:/tricio_s_application/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using E:/tricio_s_application/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from E:/tricio_s_application/.claude/get-shit-done/templates/discovery.md
...
Use E:/tricio_s_application/.claude/get-shit-done/templates/discovery.md.
