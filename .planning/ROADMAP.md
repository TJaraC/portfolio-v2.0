...
Plans:
- [x] 02-01-PLAN.md — Fix 4 TypeScript errors so tsc --noEmit exits 0 (prerequisite for BUILD-01)
- [x] 02-02-PLAN.md — Add GSAP manual chunk to vite.config.ts and add missing Geist font files
- [x] 02-03-PLAN.md — Update build script to tsc --noEmit and remove recharts + prop-types
